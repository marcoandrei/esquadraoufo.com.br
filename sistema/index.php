                        ...
                        <form id="formLogin" name="formLogin" method="post" role="form" onsubmit="return false">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" id="addonLoginEmail"><i
                                            class="fa fa-user"></i></span>
                                    <input id="email" name="email" type="text" class="form-control" placeholder="email"
                                        aria-describedby="addonLoginEmail">
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon" id="addonLoginSenha"><i
                                            class="fa fa-lock"></i></span>
                                    <input id="senha" name="senha" type="password" class="form-control"
                                        placeholder="senha" aria-describedby="addonLoginSenha">
                                </div>
                            </div>

                            <button class="btn btn-sm btn-default center-block" type="submit"><i
